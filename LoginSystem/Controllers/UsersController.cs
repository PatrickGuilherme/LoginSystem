...
namespace LoginSystem.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            if (!UserEmailExists(forgotPasswordModel.Email)) ModelState.AddModelError("Email", "O e-mail não existe");
            ViewBag.MsgSuccess = null;
            if (ModelState.IsValid)
            {
                ViewBag.MsgSuccess = "Foi enviado um e-mail para você";
                SendEmail(forgotPasswordModel.Email, "Recuperação de senha", "Utilize o link para recuperar o acesso", "https://localhost:44332/Users/");
            }
            return View(forgotPasswordModel);
        }

        [HttpGet]
        public IActionResult ForgotPasswordEdit(int id) 
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult ForgotPasswordEdit(PasswordEditModel passwordEditModel)
        {
